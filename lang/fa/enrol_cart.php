...
$string['enable_guest_cart_desc'] = 'در صورت فعال بودن این گزینه، کاربران مهمان می‌توانند دوره‌ها را به سبد خرید اضافه کرده و در صورت نیاز آن‌ها را حذف کنند.';
...
$string['error_no_payment_currency_available'] = 'امکان پرداخت با هیچ واحد پولی وجود ندارد. لطفاً مطمئن شوید که حداقل یک درگاه پرداخت فعال است.';
$string['error_no_payment_gateway_available'] = 'هیچ درگاه پرداختی در دسترس نیست. لطفاً برای انتخاب درگاه پرداخت، ابتدا حساب پرداخت و واحد پول را مشخص کنید.';
