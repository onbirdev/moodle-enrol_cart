...
$string['msg_delivery_successful'] = 'Votre inscription au(x) cours ci-dessous a bien été enregistrée.';
$string['msg_delivery_filed'] = 'Votre processus d’inscription a rencontré un problème.';
$string['msg_instance_deleted'] = 'Une des inscriptions a été supprimée.';
$string['msg_already_enrolled'] = 'Vous vous êtes déjà inscrit au cours "{$a->title}".';
$string['msg_cart_changed'] = 'Le ou les articles ou le montant payable dans le panier a/ont changé.';
$string['msg_cancel_successful'] = 'Votre panier a été annulé.';
$string['msg_cancel_filed'] = 'Il y a eu un problème avec le processus de votre panier.';
$string['msg_cart_cannot_be_edited'] = 'Il n’est actuellement pas possible d’éditer ou de modifier le panier.';
